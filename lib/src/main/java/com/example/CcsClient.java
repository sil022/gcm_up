...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyD1qSkCSjSI4BJo7jEtkTsmiNnUOHMCQIM";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyD1qSkCSjSI4BJo7jEtkTsmiNnUOHMCQIM";
    ...
    public static void main(String[] args) {
        final String projectId = "282095829478";
        ...
        final String toRegId ="APA91bGFAuVCwCtUOss35mEFg5c2DR7qEOb2-uKAJVzXHOrfCaXzpNSM2oTRDSwHPNBcrEoDoDieryCyMMA-BWGc-pR4cDD4g4AckejkudyzITeBSWKz58Kg4DywLGXL8ccKgYZggYBTG0Z_fGZ9X9Jz8M5f_om8_A";
